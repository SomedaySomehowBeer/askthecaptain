...
test('every area needs a session', async ({ request }) => {
	for (const path of ['/inbox', '/inbox/x', '/inbox/contacts/x', '/settings/contacts', '/commitments', '/calendar', '/settings', '/settings/members', '/settings/connections', '/settings/inference', '/welcome']) {
