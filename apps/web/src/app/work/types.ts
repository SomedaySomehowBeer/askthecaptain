...
export type WorkTask = { id: string; revision: number; projectId: string | null; title: string; ownerId: string | null; status: TaskStatus; due: string | null; tags: { id: string; name: string }[] };
