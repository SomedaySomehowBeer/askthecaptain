...
export default async function PasskeyPage({ searchParams }: { searchParams: Promise<{ token?: string }> }) {
	...
	return (
		<main className="page page--narrow">
			...
			{session.state === 'unavailable' ? <Notice tone="attention" title="Captain can’t check your current session right now.">
				If you were already signed in, your saved sign-in has been kept: <a href="/work">go to Work</a>. Otherwise confirm your passkey below.</Notice> : null}
