...
export async function StockSection({ me, shopifyOffset = 0 }: { me: Awaited<ReturnType<typeof requireCurrent>>; shopifyOffset?: number }) {
 ...
 return <section className="card stack" aria-labelledby="stock-heading"><h2 id="stock-heading">Stock</h2><p className="secondary">Count what is here, by location. Each count is recorded with who entered it and when.</p>
