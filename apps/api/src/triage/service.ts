...
import { createDraft } from './outbox.ts';
...
export class TriageService {
 ...
 registry() {
  ...
  registry.registerStep('outbox.create', { kind: 'write', transaction: (ctx, args) => createDraft(ctx, args.thread as Thread, draftSchema.parse(args.draft).body) });
